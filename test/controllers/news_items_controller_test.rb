...
class NewsItemsControllerTest < ActionController::TestCase
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post :create, news_item: { image: @news_item.image, link: @news_item.link, texto: @news_item.texto, titulo: @news_item.titulo }
    end
  ...
  test "should update news_item" do
    patch :update, id: @news_item, news_item: { image: @news_item.image, link: @news_item.link, texto: @news_item.texto, titulo: @news_item.titulo }
    assert_redirected_to news_item_path(assigns(:news_item))
  end
